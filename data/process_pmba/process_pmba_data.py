...
from ppdsr.datasets.base_dataset import scandir
...
def main_extract_subimages(args):
    ...
    Usage:
        ...
        Typically, there are four folders to be processed for PMBA dataset.
            PMBA_train_HR
            PMBA_train_LR_bicubic/X2
            PMBA_train_LR_bicubic/X3
            PMBA_train_LR_bicubic/X4
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Prepare PMBA dataset',
